...
# -----------------------------------------------------------------------------
DEVICES = [
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive1"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive2"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive3"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive4"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive5"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive6"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive7"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive8"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive9"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive10"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive11"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive12"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive13"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive14"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive15"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive16"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive17"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive18"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive19"),
    ("PredictiveMaintenance", "predictive-maintenance_gotham.csv", "sensor_predictive20"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic1"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic2"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic3"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic4"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic5"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic6"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic7"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic8"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic9"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic10"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic11"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic12"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic13"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic14"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic15"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic16"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic17"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic18"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic19"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic20"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic"),
    ("HydraulicSystem", "hydraulic-system_gotham.csv", "sensor_hydraulic"),
   ...
   ("AirQuality", "air-quality_gotham.csv", "sensor_air6"),
   ("AirQuality", "air-quality_gotham.csv", "sensor_air7"),
   ("AirQuality", "air-quality_gotham.csv", "sensor_air8"),
   ("AirQuality", "air-quality_gotham.csv", "sensor_air9"),
   ("AirQuality", "air-quality_gotham.csv", "sensor_air10"),
